...
export class StatementComponent implements OnInit {
    ...
    select() {
        this.displayData.here = false;
        if (this.displayData.statementComponent)
            this.displayData.statementComponent.selected = false;
        this.displayData.statementComponent = this;
        this.selected = true;
    }
